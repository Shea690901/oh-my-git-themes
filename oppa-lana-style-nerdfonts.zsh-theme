...
: ${omg_is_a_git_repo_symbol:=''}            # from octicons, codepoint patched in nerdfonts
: ${omg_has_untracked_files_symbol:=''}      # tint, from fontawesome
: ${omg_has_adds_symbol:=''}                 # from fontawesome
: ${omg_has_deletions_symbol:=''}            # from fontawesome
: ${omg_has_cached_deletions_symbol:=''}     # from fontawesome
: ${omg_has_modifications_symbol:=''}        # pencil, from fontawesome
: ${omg_has_cached_modifications_symbol:=''} # file-text from octicons, codepoint patched in nerdfonts
: ${omg_ready_to_commit_symbol:=''}          # sign-in, from fontawesome
: ${omg_is_on_a_tag_symbol:=''}              # tag, from fontawesome
: ${omg_needs_to_merge_symbol:=''}           # wrench, from fontawesome
: ${omg_detached_symbol:=''}                 # chain-broken, from fontawesome
: ${omg_can_fast_forward_symbol:=''}         # angle-double-up, from fontawesome
: ${omg_has_diverged_symbol:=''}             # from octicons, codepoint patched in nerdfonts
: ${omg_not_tracked_branch_symbol:=''}       # laptop, from fontawesome
: ${omg_rebase_tracking_branch_symbol:=''}   # from octicons, codepoint patched in nerdfonts
